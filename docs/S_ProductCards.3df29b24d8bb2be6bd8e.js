...
var offset = 0;
if (document.getElementById('PopularItems')) {
  var nextslider = document.getElementById('scrollnext');
  var nextslideralt = document.getElementById('scrollnextalt');
  var previousslider = document.getElementById('scrollprevious');
  var previousslideralt = document.getElementById('scrollpreviousalt');
  var popcontainer = document.getElementById('PopContainer');
  var altcontainer = document.getElementById('AltContainer');
  popcontainer.addEventListener('scroll', function () {
  ...
  altcontainer.addEventListener('scroll', function () {
